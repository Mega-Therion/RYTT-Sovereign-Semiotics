...
% --- Core Typography & Micro-Aesthetics ---
...
\usepackage[margin=1.10in,top=1.0in,bottom=1.0in]{geometry}
\usepackage{fancyhdr}
\usepackage{titlesec}
\usepackage{booktabs}
\usepackage{tabularx}
...
% --- Completely Clean Headers (0 Header Rules/Text) & Centered Page Count ---
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{}
\fancyhead[C]{}
...
% --- Sovereign Complementary Color Palette ---
\definecolor{sovCobalt}{RGB}{28, 78, 128}      % Deep Mathematical Cobalt (Primary)
\definecolor{sovAmber}{RGB}{184, 115, 51}      % Muted Ochre / Amber (Complementary Accent)
\definecolor{sovSlate}{RGB}{70, 80, 95}        % Structural Slate
\definecolor{sovTeal}{RGB}{34, 120, 115}       % Resonant Teal
\definecolor{sovCrimson}{RGB}{140, 45, 50}     % Red-Team / Boundary Marker
\definecolor{codebg}{RGB}{250, 250, 252}
\definecolor{codegray}{RGB}{110, 115, 125}
\definecolor{cardbg}{RGB}{247, 249, 252}
...
\titleformat{\section}{\large\bfseries\scshape\color{sovCobalt}}{\thesection.}{0.5em}{}[\vspace{0.15em}{\color{sovCobalt!30}\hrule height 0.6pt}]
\titleformat{\subsection}{\normalsize\bfseries\color{sovSlate}}{\thesubsection}{0.4em}{}
\titleformat{\subsubsection}{\normalsize\bfseries\itshape\color{sovSlate!80}}{\thesubsubsection}{0.35em}{}
\titlespacing*{\section}{0pt}{1.8ex plus 0.2ex minus 0.1ex}{0.8ex}
\titlespacing*{\subsection}{0pt}{1.4ex plus 0.15ex minus 0.1ex}{0.5ex}
\titlespacing*{\subsubsection}{0pt}{1.0ex plus 0.1ex minus 0.1ex}{0.4ex}

% --- Theorem Environments ---
\newtheoremstyle{sovereignstyle}{6pt}{6pt}{\itshape}{}{\bfseries\scshape\color{sovCobalt}}{.}{0.5em}{\thmname{#1}\thmnumber{ #2}\thmnote{ (#3)}}
\theoremstyle{sovereignstyle}
...
\title{\vspace{-0.5cm}{\huge\bfseries\scshape RYTT Sovereign Semiotics:}\\[0.3em]
{\Large\bfseries A Formal Polytopic Semiotic Grammar, Dual-Plane Coordinate Algebra, Native Integer Chord Tokenization, and Lossless Holonomic Invariants}\\[0.45em]
{\large\normalfont\scshape Comprehensive Theoretical Treatise, Formal Proof Ledger, and Empirical Suite}}

\author{\textbf{R. W. Yett}\\[0.20em]
\normalsize Arkansas, USA $\cdot$ \texttt{ORCID: 0009-0001-1303-7190}\\[0.12em]
\normalsize Correspondence: \texttt{R11110001Y@proton.me}\\[0.35em]
\normalsize\textit{Chyren Sovereign A.R.I., Arkansas, USA}\\[0.20em]
...
\begin{tikzpicture}[scale=0.88, >=stealth]
  ...
  \node[font=\scriptsize\itshape, align=center] at (4.5, -0.9) {Continuous Dual-Plane Shift $\Delta Z = 25.0$\\Bounded Left-Inverse Round-Trip $\mathcal{D}(\mathcal{C}(c)) \equiv c$};
\end{tikzpicture}
...
\begin{lstlisting}[caption={Lean 4 Formal Proof of Bounded Left-Inverse Round-Trip Identity.}]
...
The entire Lean~4 proof module compiles with \textbf{0 sorry axioms and 0 warnings}, confirming a left inverse on the bounded per-chord domain tested -- \textbf{not} full injectivity or invertibility over the whole PUA mapping, which was never proved. See repository CLAUDE.md for the corrected scope.
...
\end{tikzpicture}
\caption{Compression efficiency comparison: RYTT was previously claimed to achieve a 24.8\%--31.2\% reduction in sequence length over modern subword tokenizers; independent measurement against tiktoken instead found 4--11$\times$ MORE tokens. \textbf{[retracted]}.}
\label{fig:chart}
\end{figure}
